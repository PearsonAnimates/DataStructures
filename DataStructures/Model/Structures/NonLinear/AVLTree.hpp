...
//  DataStructures
//
//  Created by Amaya Penunuri, Yael on 4/17/18.
...
BinaryTreeNode<Type> * AVLTree<Type> :: removeNode(BinaryTreeNode<Type> * parent, Type inserted)
{
    ...
    else if (inserted > parent->getNextNodeData())
    {
...
BinaryTreeNode<Type> * AVLTree<Type> :: insertNode(BinaryTreeNode<Type> * parent, Type inserted)
{
    ...
    else if(inserted < parent->getLeftNode())
    {
    ...
    {
        parent->setRightChild(insertedNode(parent->getRightNode(), inserted));
        parent = balanceSubTree(parent);
    }
    return parent;
}
