...
void LinkedListTester :: testListBasics()
{
    ...
    cout << numbers.getEnd()->getData() << " It is at the end of the list and should be 9" << endl;
    
    numbers.add(0);
    cout << numbers.getFront()->getData() << " It is at the front of the list and should be 9" << endl;
    cout << numbers.getEnd()->getData() << " It is at the end of the list and should be 0" << endl;
    
    numbers.addAtIndex(1,2);
    numbers.add(324);
    
    cout << numbers.getFront()->getData() << " It is at the front of the list and should be 9" << endl;
    cout << numbers.getEnd()->getData() << " It is at the end of the list and should be 324" << endl;
    ...
    cout << numbers.getFront()->getData() << " It is at the front of the list and should be 2312" << endl;
    cout << numbers.getEnd()->getData() << " It is at the end of the list and should be 32567" << endl;
}
...
void LinkedListTester :: testListWithData()
{
    ...
    LinkedList<CrimeData> crimes = FileController :: readDataToList("/Users/yama6920/CTEC Data Project thingys/DataStructures/DataStructures/Data/crime.csv");
    listTimer.stopTimer();
